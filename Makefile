...
# Template: app
# Command: C:\Qt\6.8.1\mingw_64\bin\qmake.exe -o Makefile symulatorUAR.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: symulatorUAR.pro C:/Qt/6.8.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.8.1/mingw_64/mkspecs/features/spec_pre.prf \
		...
		symulatorUAR.pro \
		C:/Qt/6.8.1/mingw_64/lib/Qt6PrintSupport.prl \
	...
	$(QMAKE) -o Makefile symulatorUAR.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
